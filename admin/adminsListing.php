...
$admins = $adminsCollection->get(array(), $offset, $pageResults, $search, $order);

$totalRows = count($adminsCollection->get(array(), -1, 0, $search));
$totalRows = ($totalRows == 0)? 1 : $totalRows;

$paginator = new Pagination();
$paginator->setPerPage($pageResults);
$paginator->setTotalRows($totalRows);
$paginator->setBaseUrl("adminsListing.php?perPage={$pageResults}&orderBy={$orderBy}&search={$search}");
?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach ($admins as $admin) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="adminEdit.php?id=<?php echo $admin->getId();?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                                    <a href="adminDelete.php?id=<?php echo $admin->getId();?>" class="btn btn-white btn-sm"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
