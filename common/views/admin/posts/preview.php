    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="index.php?c=posts">Blog</a>
                </li>
                <li class="active">
        ...
        <div class="ibox">
            <div class="ibox-content">
                <div class="pull-right tooltip-demo">
                    <a href="index.php?c=posts&m=update&id=<?php echo $post->getId(); ?>" class="btn btn-white btn-xs" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Post"><i class="fa fa-pencil"></i> Edit</a>
                </div>
