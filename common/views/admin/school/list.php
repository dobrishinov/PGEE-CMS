                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="search" value="<?php echo $search; ?>" placeholder="Search School Post">
                        ...
                        <div class="col-md-2 col-md-offset-1">
                            <a href="index.php?c=school&m=insert" class="btn btn-primary btn">New School Post</a>
                        </div>
                        ...
                        <?php foreach($school as $item) { ?>
                            <tr>
                                <td class="project-status">
                                    <span class="label label-primary"><?php echo $item->getCategoryName(); ?></span>
                                </td>
                                <td class="col-md-3">
                                    <a href="index.php?c=school&m=preview&id=<?php echo $item->getId(); ?>"><?php echo $item->getTitle(); ?></a>
                                    <br>
                                    <small>Created <?php echo $item->getDate(); ?></small>
                                    <br>
                                    <small>by <?php echo $item->getAuthorName();?></small>
                                </td>
                                <td colspan="2" class="col-md-3">
                                    <?php echo $item->getDescription();?>
                                </td>
                                <td colspan="2" class="col-md-2">
                                    <img src="uploads/schoolImages/thumbnails/<?php echo $item->getImage(); ?>" alt="" style="width:80px; height:80px;">
                                </td>
                                <td class="project-actions">
                                    <a href="index.php?c=school&m=preview&id=<?php echo $item->getId();?>" class="btn btn-white btn-sm"><i class="fa fa-eye"></i> View </a>
                                    <a href="index.php?c=school&m=update&id=<?php echo $item->getId();?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                                    <a href="index.php?c=school&m=delete&id=<?php echo $item->getId();?>" class="btn btn-white btn-sm"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                        <?php }  ?>
                        </tbody>
