    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Create School Post</strong>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="ibox-title">
            <div class="panel-body">
                ...
                <fieldset class="form-horizontal">
                    <form id="schoolForm" action="" method="post" enctype="multipart/form-data">

                        <div class="form-group <?php echo (array_key_exists('title', $errors))? 'has-error' : ''; ?>">
                            <label class="col-sm-2 control-label">School Post Title:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group <?php echo (array_key_exists('description', $errors))? 'has-error' : ''; ?>">
                            <label class="col-sm-2 control-label">School Post Description:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group <?php echo (array_key_exists('image', $errors))? 'has-error' : ''; ?>">
                            <label class="col-sm-2 control-label">School Post Thumbnail:</label>
                            <div class="col-sm-10">
                        ...
                        <input class="btn btn-primary pull-right" type="submit" name="submit" value="Save School Post">
